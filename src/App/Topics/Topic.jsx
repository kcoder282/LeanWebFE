        ...
        <div className="container-fluid">
          <div className="row justify-content-center">
            <div className="px-2 col col-sm-10 col-md-9 col-lg-6 ">
              <div className="mt-4 shadow p-2 d-flex align-items-start"
              ...
              {send ? (
                <div
                  ...
                  style={{ borderRadius: ".5rem ", zIndex:2 }}
                >
              ...
              <div className="bg-white mt-4 position-relative" style={{zIndex:0}}>
                {topics.map((e, i) => (
                  <div
                    key={i}
                    ...
                    <div className="p-3">
                      <div className="row flex-fill align-items-start">
                        ...
                        <div className="col-md-6 d-flex">
                          ...
                          <i onClick={()=>deletetopic(e.id, i)} className="close-btn ml-2 fi fi-rr-cross-circle text-danger"/>
                          :""}
                        </div>
                      </div>
